...
print(my_tuple) # output is (1, 'hello', 3.14)
...
print(count_tuple.count(1)) # one appears 3 times

# Finding the index of an element
# Question: What is the index of the first occurrence of the number 2 in count_tuple?
print(count_tuple.index(2)) # 2's first occurrence is at index 1
...
gt_three(list_2) # output will be []
...
a = DataExtractor(10)
print(a.some_value) # will print 10
...
entryIndex = 5
try:
    print(f'The output of l for index {entryIndex} is {l[entryIndex]}.')
except IndexError as i:
    print(f'Index {entryIndex} does not exists in list l')
